...
public class JoystickProfile {
	...
	public static void init(double x1, double y1, double x2, double y2) {
		profilingPoints = new double[2][2];
        profilingPoints[0][0] = x1;
        profilingPoints[0][1] = y1;
        profilingPoints[1][0] = x2;
        profilingPoints[1][1] = y2;
	}
